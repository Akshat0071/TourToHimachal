                    ...
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                                        ...
                                        <FormControl>
                                            <div className="flex gap-1">
                                                {[1, 2, 3, 4, 5].map((star) => (
                                                    ...
                                                    >
                                                        <Star
                                                            className={`w-8 h-8 ${star <= (hoverRating || field.value)
                            ...
                            <div className="flex justify-end gap-4">
                                ...
                                <Button type="submit" className="bg-mountain-blue text-white hover:bg-mountain-blue/90" disabled={isSubmitting}>
                                    {isSubmitting ? (
                                        <>
