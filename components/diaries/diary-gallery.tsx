  ...
  return (
    <>
      <motion.section
        ...
        className="py-12"
      >
        <h2 className="text-2xl md:text-3xl font-serif font-bold text-foreground mb-6">Photo Gallery</h2>
      ...
      <AnimatePresence>
        {selectedIndex !== null && (
          ...
          >
            {/* Close Button */}
            <button className="absolute top-4 right-4 text-white/70 hover:text-white p-2 z-10" onClick={closeLightbox}>
              <X className="h-8 w-8" />
            </button>
